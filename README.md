...
A set of utilities and typescript transformers to cover storybook stories with cypress component tests.

[See here](md-docs/README.md) for detailed module documentation in markdown, or this documentation in [github pages](https://quotapath.github.io/cypress-storybook-component-tests/) and some documentation, though more of a testing artifact, at the [hosted storybook](https://quotapath.github.io/cypress-storybook-component-tests/storybook/)
...
You can opt out of allowing any or all of these syntaxes via cypress configuration. See [config module documentation](md-docs/modules/config.md#cytestconfig) for more details.
